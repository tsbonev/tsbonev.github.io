(function () {
	const translations = {
		en: {
			...
			'printSeatingChartBtn': '🖨️ Print Seating Chart',
		...
		bg: {
			...
			'printSeatingChartBtn': '🖨️ Печат Схема на Местата',
			'printBtn': '🖨️ Печат Схема на Масите',
			...
			'toggleSidebar': 'Страничната Лента',
			'unitMeter': 'м',
